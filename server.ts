    ...
    const candidateDiscoveredPool = [
      {
        ...
        matchScore: 98,
        source: 'direct_rig',
        appliedVia: 'Shelf Drilling Careers Direct',
        url: 'https://www.shelfdrilling.com/careers/',
        sourceUrl: 'https://www.shelfdrilling.com/careers/',
        ...
        status: 'new_match',
        description: 'Seeking Senior Rig Mechanic with verified Jack-Up experience for Arabian Gulf operations. Responsible for maintenance and overhaul of CAT 3516 engines, Varco top drives, high pressure mud pumps, and jacking systems.',
        matchAnalysis: {
          overallScore: 98,
          machineryFit: 100,
          ...
          rigTypeFit: 100,
          keyStrengths: [
            'Direct experience on Shelf Drilling rigs (C.E. Thornton & JTA in Mumbai High)',
            'Over 12 years with Caterpillar 3516B engines & Varco TDS-8SA',
            'Active BOSIET & valid international passport to 2033',
          ],
          missingOrGaps: [],
...
I am writing to express my strong interest in the Senior Rig Mechanic position for your Persian Gulf Jack-Up fleet. Having previously spent over 7 years with Shelf Drilling on the C.E. Thornton and JTA Jack-Up rigs drilling for ONGC in Mumbai High, I am thoroughly familiar with your safety culture, JDE PMS protocols, and operational standards.
...
Phone/WhatsApp: +91-7077869585 | Email: jogendra.dipeng11@gmail.com`,
      ...
      {
        id: `crawl-transocean-${timestamp}-2`,
...
Email: jogendra.dipeng11@gmail.com | Mobile: +91-7077869585`,
      ...
      {
        id: `crawl-slb-${timestamp}-3`,
        title: 'Maintenance Engineer - Mechanical Systems',
        ...
        sourceUrl: 'https://careers.slb.com/',
...
Email: jogendra.dipeng11@gmail.com`,
      ...
      {
        id: `crawl-noble-${timestamp}-4`,
        title: 'Lead Rig Mechanic - Harsh Environment Jack-Up',
        targetRole: 'Senior Rig Mechanic',
        company: 'Noble Corporation',
        location: 'Stavanger / North Sea Sector',
        country: 'Norway',
        ...
        sourceUrl: 'https://noblecorp.com/careers/',
        ...
        emailRetrievedFromAd: true,
        status: 'new_match',
        description: 'Noble Corporation is seeking Lead Rig Mechanics for North Sea jack-up and semi-submersible drilling units. Candidates must have extensive experience in high-pressure hydraulic and mud pump overhaul.',
        matchAnalysis: {
          overallScore: 94,
          machineryFit: 95,
...
I am writing to apply for the Lead Rig Mechanic role on your North Sea fleet. Having spent over 12 years maintaining heavy mechanical and hydraulic systems on offshore Jack-ups and drilling units, I offer comprehensive troubleshooting and overhaul capabilities.
...
Email: jogendra.dipeng11@gmail.com`,
      },
      {
        ...
        sourceUrl: 'https://www.saipem.com/en/careers',
